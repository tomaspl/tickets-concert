#!/usr/bin/env node
// Small script to collapse multiple consecutive blank lines into a single blank line
// for .html, .ts, .js, .css files under the repository.
...
function fixFile(file) {
  ...
  // Replace 3 or more newlines with 2 newlines, then 2 with 1; loop to be safe
