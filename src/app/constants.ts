...
export const messageTicketsPerFamily = !preventaAvailable
  ...
  : 'Solo puede reservar 2 ubicaciones por el momento. El 6/11 se pone a disposicion el resto de las ubicaciones del teatro'
...
export const returnMessage = preventaAvailable
  ? 'Vuelva el jueves 6 de noviembre para reservar el resto de sus entradas.'
  : ''
export const availableSoon =
  'Esta ubicacion estará disponible desde el jueves 6 de noviembre'
